...
Delete Temp File from prefetch folder

Empty Recycle Bin (If the trash is empty or you have set it to automatic cleaning, the program will not execute any commands.)

Unistalling All Pre-installed Windows Application:
